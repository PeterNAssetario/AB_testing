...
from evidently.renderers.render_utils import get_distribution_plot_figure, get_distribution_with_time_plot_figure
...
class DataDriftTableRenderer(MetricRenderer):
    ...
    def _generate_column_params(self, column_name: str, data: ColumnDataDriftMetrics) -> Optional[RichTableDataRow]:
        ...
        #     data.column_type == "num"
        # ):
        #     fig2 = get_distribution_with_time_plot_figure()
        #     violins = plotly_figure(title="", figure=fig2)
        #     details.with_part("DISTRIBUTION w.r.t. TIME", info=violins)
